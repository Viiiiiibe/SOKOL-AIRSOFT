...
urlpatterns = [
    ...
    path('order/<int:order_number>/completed/', views.order_completed, name='order-completed'),
    path('delivery_order/', views.delivery_order_view, name='delivery-order-view'),
    path('delivery_order/<int:order_number>/completed/', views.delivery_order_completed,
