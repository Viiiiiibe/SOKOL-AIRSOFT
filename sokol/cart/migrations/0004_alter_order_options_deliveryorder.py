# Generated by Django 5.0.2 on 2024-03-29 21:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cart', '0003_order_manager_has_been_notified_and_more'),
    ...
    operations = [
        migrations.AlterModelOptions(
            name='order',
            options={'verbose_name': 'Заказ из магазина', 'verbose_name_plural': 'Заказы из магазина'},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_phone', phonenumber_field.modelfields.PhoneNumberField(max_length=128, null=True, region=None, verbose_name='Тлефон заказчика')),
                ('order_vk', models.CharField(blank=True, max_length=150, null=True, verbose_name='VK заказчика')),
                ('order_telegram', models.CharField(blank=True, max_length=150, null=True, verbose_name='Telegram заказчика')),
