...
class Product(models.Model):
    ...
    product_description = models.TextField(verbose_name='Описание', blank=True, null=True)
    price = models.FloatField(verbose_name='Цена в рублях', )
    available = models.BooleanField("Наличие", default=True)
    items_left = models.IntegerField('Осталось единиц товара', blank=True, null=True)
    ...
    girbox = models.TextField('Гирбокс', blank=True, null=True)
